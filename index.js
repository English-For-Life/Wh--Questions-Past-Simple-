...
function getNewQuestion(){
    ...
    //remove the questionIndex from the availableQuestion Array so that question doesn't repeat
...
//make all the options unclickable once the user select an option(RESTRICT THE USER CHANGE THE OPTION AGAIN)
